...
class VenderBaloto():
    ...
    def venderBoletoBaloto(self,vendedor,varId,varFecha,varCedula,varNum1,varNum2,varNum3,varNum4,varNum5,varNum6):
        vendedor.venderBoletoBaloto(varId,varFecha,varCedula,varNum1,varNum2,varNum3,varNum4,varNum5,varNum6)
    ...
    #datos
        tk.Label(self.ventana, text='Vender Boleto Baloto').grid(row=0, columns=6)
    ...
    #botones
        botonVender = tk.Button(self.ventana, text='Vender', command=lambda:self.venderBoletoBaloto(vendedor, self.__varId, self.__varFecha, self.__varCedula, self.__varNum1, self.__varNum2, self.__varNum3, self.__varNum4, self.__varNum5, self.__varNum6)).grid(row=5, column=0)
