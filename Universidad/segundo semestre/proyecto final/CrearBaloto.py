...
class CrearBaloto():
    ...
    def crearBaloto(self,administrador, varNum1, varNum2, varNum3, varNum4, varNum5, varNum6):
        administrador.realizarSorteoBaloto(varNum1, varNum2, varNum3, varNum4, varNum5, varNum6)
    ...
    #datos
        tk.Label(self.ventana, text='Realizar Sorteo Baloto').grid(row=0, columns=6)
    ...
    #botones
        botonSortear = tk.Button(self.ventana, text='Sortear', command=lambda:self.crearBaloto(administrador, self.__varNum1, self.__varNum2, self.__varNum3, self.__varNum4, self.__varNum5, self.__varNum6)).grid(row=2, column=1,columns=3)
